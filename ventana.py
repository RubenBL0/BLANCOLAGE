...
class Ui_VenPrincipal(object):
    def setupUi(self, VenPrincipal):
        ...
        self.entDireccion = QtWidgets.QLineEdit(self.gridLayoutWidget_6)
        ...
        self.entDireccion.setStyleSheet("background-color:rgb(209, 255, 208)")
        self.entDireccion.setMaxLength(50)
        self.entDireccion.setObjectName("entDireccion")
        self.gridLayout_6.addWidget(self.entDireccion, 0, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.chkTar, 0, 7, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lblPago, 0, 5, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.chkTrans, 0, 8, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.chkEfec, 0, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.lblCliAlta, 1, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.editClialta, 1, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.btnCalendar, 1, 8, 1, 1)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../../Downloads/reload.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.gridLayout.addWidget(self.btnReloadCli, 1, 4, 1, 1)
