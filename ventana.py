...
class Ui_VenPrincipal(object):
    def setupUi(self, VenPrincipal):
        ...
        self.gridLayout_5.addWidget(self.lblStatus, 4, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.lblFecha, 3, 1, 1, 1)
        ...
        VenPrincipal.setTabOrder(self.btnSalir, self.tabWidget)
